...
import { ViewShopModule } from './viewShop.module';
import { HttpClientModule } from '@angular/common/http';
import { Injectable } from '@angular/core';
import {author, title, userId, city_id, district_id} from '../../global-variable';
...
export class ViewShopComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.viewShop.district_id = city_id;
    this.viewShop.city_id = district_id;
  }
  ...
  async doGET(id) {
    console.log("GET");
    let url = `http://localhost:5102/item/getByshowroom?showroom_id=`+id;
  ...
  async doGETByShowRoomId(id) {
    console.log("GET");
    let url = `http://localhost:5102/shop/getByShowRoom?showroom_id=`+id;
    this.http.get(url).subscribe(res => 
      // console.log(res),
      this.showRoomDetail = res
    );
  }
  ...
  async doGETcityListByDistrictId() {
    ...
    this.http.post(url, {
      "district_id":this.viewShop.district_id
      // "district_id":1
    }
    )
    .subscribe(res => 
