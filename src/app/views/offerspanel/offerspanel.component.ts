...
@Component({
  templateUrl: 'offerspanel.component.html',
  providers: [
...
export class OffersPanelComponent implements OnInit, OnDestroy {
  ...
  async doGET() {
    console.log("GET");
    let url = `http://localhost:5102/item/getdiscountitemsforadmin`;
