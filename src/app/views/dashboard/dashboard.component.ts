...
doPOSTClick() {
  ...
  sessionStorage.setItem("searchWord", this.dashboard.name);
}
  ...
  doGET() {
    console.log("GET");
    let url = `http://localhost:5102/item/get-offers`;
  ...
  doGETRecent() {
    console.log("GET");
    let url = `http://localhost:5102/item/get-recent`;
    this.http.get(url).subscribe(res => 
      // console.log(res),
      this.totalAngularPackages1 = res
    );
  }
